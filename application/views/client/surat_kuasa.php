                ...
                <div class="col-lg">
                    <div class="p-5">
                        ...
                        <?php if ($this->session->flashdata('flash')) : ?>
                            <div class="row mt-3">
                                <div class="col-md-6">
                                    <div class="alert alert-success alert-dismissible fade show" role="alert">Teima
                        ...
                        <?php $notaris; ?>
                        <?php $client; ?>
                        <?php echo form_open_multipart('client/sk'); ?>
                        ...
                        <div class="col-sm-10">
                            <input type="hidden" class="form-control" id="jenis" placeholder="jenis" name="jenis" value="Surat Kuasa" readonly>
                        </div>
                        <div class="col-sm-10">
